...
class MathJax implements Component\Component
{
    ...
    /**
     * Mathjax Script - compiled bundle of components
     */
    public const SCRIPT = 'tex-svg.js';

    /**
     * Files /directories of assest which are loaded by the MathJax Script
     */
    public const ASSETS = [
        'a11y',
        'adaptors',
    ...
    public function init(
        ...
        //        new Component\Resource\ComponentJS($this, "ilMathJaxBrowserConfig.js");
        //
        foreach (self::ASSETS as $source) {
            $contribute[Component\Resource\PublicAsset::class] = fn() =>

            // Mathjax scripts load their from subdirectories with reelative path
